...
p_merc = a_merc**(3/2)                              #period of orbit #estimation through Keplers 3rd
...
p_venus = a_venus**(3/2)                            #period of orbit #estimation through Keplers 3rd
...
p_jup = a_jup**(3/2)                                #period of orbit #estimation through Keplers 3rd
...
p_sat = a_sat**(3/2)                                #period of orbit #estimation through Keplers 3rd
...
p_uran = a_uran**(3/2)                              #period of orbit #estimation through Keplers 3rd
...
p_nep = a_nep**(3/2)                                #period of orbit #estimation through Keplers 3rd
...
plt.plot(sol_x_mars, sol_y_mars, '*g', label = "Rocket Path", markersize = 4)
...
#plt.plot(x_merc(time), y_merc(time), 'o', label = "Mercury", markersize = .5)
#plt.plot(x_ven(time), y_ven(time), 'o', label = "Venus", markersize = 1)
plt.plot(x_earth(sol_mars.t), y_earth(sol_mars.t), 'ob', label = "Earth", markersize = 1)
plt.plot(x_mars(sol_mars.t), y_mars(sol_mars.t), 'or', label = "Mars", markersize = 1)
#plt.plot(x_jup(time), y_jup(time), 'o', label = "Jupiter", markersize = 3)
#plt.plot(x_sat(time), y_sat(time), 'o', label = "Saturn", markersize = 3)
#plt.plot(x_uran(time), y_uran(time), 'o', label = "Uranus", markersize = 2)
#plt.plot(x_nep(time), y_nep(time), 'o', label = "Neptune", markersize = 2)
